...
import (
	monotonicclock "example.com/example/internal/gen/wasi/clocks/monotonic-clock"
	"example.com/example/internal/gen/wasi/io/poll"
	"example.com/example/internal/gen/wasi/io/streams"
	"example.com/example/internal/gen/wasi/sockets/network"
